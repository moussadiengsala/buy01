...
public class Response<T> {
    ...
    // ============ ESSENTIAL FUNCTIONAL INTERFACES ============

//    @FunctionalInterface
//    public interface Builder<T> {
//        Response<T> build(T data, String message, HttpStatus status);
//    }
...
//
//    public static <T> Response<T> ok(T data, String message) {
//        return Response.response(data, message, HttpStatus.OK.value());
//    }
//
//    public static <T> Response<T> ok(T data) {
//        return Response.response(data, "Success", HttpStatus.OK.value());
//    }
//
//    public static <T> Response<T> created(T data, String message) {
//        return Response.response(data, message, HttpStatus.CREATED.value());
//    }
//
//    public static <T> Response<T> created(T data) {
//        return Response.response(data, "Resource created successfully", HttpStatus.CREATED.value());
//    }
//
//    public static <T> Response<T> notFound(String message) {
//        return Response.response(null, message, HttpStatus.NOT_FOUND.value());
//    }
//
//    public static <T> Response<T> notFound() {
//        return Response.response(null, "Resource not found", HttpStatus.NOT_FOUND.value());
//    }
//
//    public static <T> Response<T> badRequest(String message) {
//        return Response.response(null, message, HttpStatus.BAD_REQUEST.value());
//    }
//
//    public static <T> Response<T> badRequest(T data, String message) {
//        return Response.response(data, message, HttpStatus.BAD_REQUEST.value());
//    }
//
//    public static <T> Response<T> badRequest(List<String> errors, String message) {
//        return Response.response(null, message, HttpStatus.BAD_REQUEST.value(), errors);
//    }
//
//    public static <T> Response<T> unauthorized(String message) {
//        return Response.response(null, message, HttpStatus.UNAUTHORIZED.value());
//    }
//
//    public static <T> Response<T> unauthorized() {
//        return Response.response(null, "Unauthorized access", HttpStatus.UNAUTHORIZED.value());
//    }
//
//    public static <T> Response<T> forbidden(String message) {
//        return Response.response(null, message, HttpStatus.FORBIDDEN.value());
//    }
//
//    public static <T> Response<T> forbidden() {
//        return Response.response(null, "Access forbidden", HttpStatus.FORBIDDEN.value());
//    }
//
//    public static <T> Response<T> conflict(String message) {
//        return Response.response(null, message, HttpStatus.CONFLICT.value());
//    }
//
//    public static <T> BiFunction<String, HttpStatus, Response<T>> error = (String message, HttpStatus status) -> {
//        return Response.response(null, message, status.value());
//    }
//
//    public static <T> Response<T> internalServerError(String message) {
//        return Response.response(null, message, HttpStatus.INTERNAL_SERVER_ERROR.value());
//    }
//
//    public static <T> Response<T> internalServerError() {
//        return Response.response(null, "Internal server error", HttpStatus.INTERNAL_SERVER_ERROR.value());
//    }
//
//    public boolean isSuccess() {
