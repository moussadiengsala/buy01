...
var Galleria = class _Galleria extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    standalone: false,
    features: [ɵɵProvidersFeature([GalleriaStyle]), ɵɵInputTransformsFeature, ɵɵInheritDefinitionFeature, ɵɵNgOnChangesFeature],
    decls: 3,
    vars: 2,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(Galleria, {
    className: "Galleria",
    filePath: "galleria.ts",
    lineNumber: 89
  });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(GalleriaContent, {
    className: "GalleriaContent",
    filePath: "galleria.ts",
    lineNumber: 503
  });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(GalleriaItemSlot, {
    className: "GalleriaItemSlot",
    filePath: "galleria.ts",
    lineNumber: 637
  });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(GalleriaItem, {
    className: "GalleriaItem",
    filePath: "galleria.ts",
    lineNumber: 817
  });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(GalleriaThumbnails, {
    className: "GalleriaThumbnails",
    filePath: "galleria.ts",
    lineNumber: 1058
  });
})();
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(GalleriaModule, {
    declarations: [Galleria, GalleriaContent, GalleriaItemSlot, GalleriaItem, GalleriaThumbnails],
    imports: [CommonModule, SharedModule, Ripple, TimesIcon, ChevronRightIcon, ChevronUpIcon, ChevronDownIcon, ChevronLeftIcon, WindowMaximizeIcon, WindowMinimizeIcon, FocusTrap],
    exports: [CommonModule, Galleria, GalleriaContent, GalleriaItemSlot, GalleriaItem, GalleriaThumbnails, SharedModule]
  });
