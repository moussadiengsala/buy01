...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(AccordionPanel, {
    className: "AccordionPanel",
    filePath: "accordion.ts",
    lineNumber: 93
  });
})();
var AccordionHeader = class _AccordionHeader extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function AccordionHeader_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵattribute("id", ctx.id())("aria-expanded", ctx.active())("aria-controls", ctx.ariaControls())("role", "button")("tabindex", "0")("data-p-active", ctx.active())("data-p-disabled", ctx.disabled())("data-pc-name", "accordionheader");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(AccordionHeader, {
...
var AccordionContent = class _AccordionContent extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function AccordionContent_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵsyntheticHostProperty("@content", ctx.active() ? ɵɵpureFunction1(10, _c4, ɵɵpureFunction1(8, _c3, ctx.pcAccordion.transitionOptions)) : ɵɵpureFunction1(14, _c5, ɵɵpureFunction1(12, _c3, ctx.pcAccordion.transitionOptions)));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(AccordionContent, {
...
var AccordionTab = class _AccordionTab extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    features: [ɵɵProvidersFeature([AccordionStyle]), ɵɵInputTransformsFeature, ɵɵInheritDefinitionFeature],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(AccordionTab, {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(Accordion, {
    className: "Accordion",
    filePath: "accordion.ts",
    lineNumber: 682
  });
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(AccordionModule, {
    imports: [Accordion, AccordionTab, SharedModule, AccordionPanel, AccordionHeader, AccordionContent],
    exports: [Accordion, AccordionTab, SharedModule, AccordionPanel, AccordionHeader, AccordionContent]
  });
})();
