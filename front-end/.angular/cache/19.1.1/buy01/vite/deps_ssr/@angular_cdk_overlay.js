...
var FixedSizeVirtualScrollStrategy = class {
  _scrolledIndexChange = new import_rxjs2.Subject();
...
var ScrollDispatcher = class _ScrollDispatcher {
  ...
  _scrolled = new import_rxjs2.Subject();
...
var CdkScrollable = class _CdkScrollable {
  ...
  _elementScrolled = new import_rxjs2.Observable((observer) => this.ngZone.runOutsideAngular(() => (0, import_rxjs2.fromEvent)(this.elementRef.nativeElement, "scroll").pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe(observer)));
  constructor() {
  }
  ngOnInit() {
...
var ViewportRuler = class _ViewportRuler {
  ...
  _change = new import_rxjs2.Subject();
  /** Used to reference correct document/window */
  _document = inject(DOCUMENT, {
    optional: true
  });
...
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  _detachedSubject = new import_rxjs2.Subject();
  /** Emits when the rendered range changes. */
  _renderedRangeSubject = new import_rxjs2.Subject();
  ...
  scrolledIndexChange = new import_rxjs2.Observable((observer) => this._scrollStrategy.scrolledIndexChange.subscribe((index) => Promise.resolve().then(() => this.ngZone.run(() => observer.next(index)))));
  ...
  _viewportChanges = import_rxjs2.Subscription.EMPTY;
...
var CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  viewChange = new import_rxjs2.Subject();
  /** Subject that emits when a new DataSource instance is given. */
  _dataSourceChanges = new import_rxjs2.Subject();
...
var CdkVirtualScrollableWindow = class _CdkVirtualScrollableWindow extends CdkVirtualScrollable {
  _elementScrolled = new import_rxjs2.Observable((observer) => this.ngZone.runOutsideAngular(() => (0, import_rxjs2.fromEvent)(document, "scroll").pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe(observer)));
  constructor() {
    super();
  ...
  _observeElement(element) {
    return this._ngZone.runOutsideAngular(() => {
      if (!this._observedElements.has(element)) {
        const stream = new import_rxjs4.Subject();
...
var BreakpointObserver = class _BreakpointObserver {
  ...
  observe(value) {
    ...
    stateObservable = (0, import_rxjs5.concat)(stateObservable.pipe((0, import_operators3.take)(1)), stateObservable.pipe((0, import_operators3.skip)(1), (0, import_operators3.debounceTime)(0)));
...
var Typeahead = class {
  _letterKeyStream = new import_rxjs6.Subject();
  _items = [];
  _selectedItemIndex = -1;
  /** Buffer for the letters that the user has pressed */
  _pressedLetters = [];
  _skipPredicateFn;
  _selectedItem = new import_rxjs6.Subject();
...
var InputModalityDetector = class _InputModalityDetector {
  ...
  _modality = new import_rxjs6.BehaviorSubject(null);
...
var FocusMonitor = class _FocusMonitor {
  ...
  _stopInputModalityDetector = new import_rxjs6.Subject();
  constructor() {
  ...
  monitor(element, checkChildren = false) {
    ...
    const info = {
      checkChildren,
      subject: new import_rxjs6.Subject(),
      rootNode
    };
...
var OverlayRef = class {
  ...
  _backdropTimeout;
  _backdropClick = new import_rxjs7.Subject();
  _attachments = new import_rxjs7.Subject();
  _detachments = new import_rxjs7.Subject();
  _positionStrategy;
  _scrollStrategy;
  _locationChanges = import_rxjs7.Subscription.EMPTY;
  ...
  _keydownEvents = new import_rxjs7.Subject();
  /** Stream of mouse outside events dispatched to this overlay. */
  _outsidePointerEvents = new import_rxjs7.Subject();
  _renders = new import_rxjs7.Subject();
  _afterRenderRef;
...
var FlexibleConnectedPositionStrategy = class {
  ...
  _positionChanges = new import_rxjs7.Subject();
  /** Subscription to viewport size changes. */
  _resizeSubscription = import_rxjs7.Subscription.EMPTY;
...
var CdkConnectedOverlay = class _CdkConnectedOverlay {
  ...
  _overlayRef;
  _templatePortal;
  _backdropSubscription = import_rxjs7.Subscription.EMPTY;
  _attachSubscription = import_rxjs7.Subscription.EMPTY;
  _detachSubscription = import_rxjs7.Subscription.EMPTY;
  _positionSubscription = import_rxjs7.Subscription.EMPTY;
  _offsetX;
  _offsetY;
  _position;
